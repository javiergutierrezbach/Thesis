...
def combined_model(file_1,file_2,file_3, output_file): 
    ...
    input_data_one = torch.randn(1, 6, dtype=torch.float64)  
    input_data_two = torch.randn(1, 6, dtype=torch.float64)
    input_data_three = torch.randn(1, 8, dtype=torch.float64)

    input_data_one = torch.tensor([[1,1,1,1,1,1]], dtype=torch.float64)
    input_data_two = torch.tensor([[1,1,1,1,1,1]], dtype=torch.float64)
    input_data_three = torch.tensor([[1,1,1,1,1,1,1,1]], dtype=torch.float64)
    ...
    x = torch.randn(1,6, dtype=torch.float64,requires_grad=True)
    y = torch.randn(1,6, dtype=torch.float64,requires_grad=True)
    z = torch.randn(1,8, dtype=torch.float64,requires_grad=True)
