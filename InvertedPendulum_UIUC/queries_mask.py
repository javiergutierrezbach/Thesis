...
class Queries:
    ...
    def check_descent_safe(self, unsafe_threshold_pos, docking_threshold_pos, input=[[-3, -2], [-3, -2]]):
        ...
        # network.setLowerBound(th_t, 10*input[0][0])
        # network.setUpperBound(th_t, 10*input[0][1])
        # network.setLowerBound(thdot_t, 10*input[1][0])
        # network.setUpperBound(thdot_t, 10*input[1][1])

        # network.setLowerBound(th_1, 10*input[0][0])
        # network.setUpperBound(th_1, 10*input[0][1])
        # network.setLowerBound(thdot_1, 10*input[1][0])
        # network.setUpperBound(thdot_1, 10*input[1][1])
        ...
        # network.setLowerBound(th_0, -0.32)
        # network.setUpperBound(th_0, -0.2)
        # network.setLowerBound(thdot_0, 0)
        # network.setUpperBound(thdot_0, 0.3)

        # network.setLowerBound(th_0, -0.2)
        # network.setUpperBound(th_0, -0.2)
        # network.setLowerBound(thdot_0, 0.257293212950)
        # network.setUpperBound(thdot_0, 0.257293212950)
...
if __name__ == "__main__":
    ...
    cert_file = "/Users/javiergutierrez/Documents/Thesis/Thesis_Repo/InvertedPendulum_UIUC/models_epsl_5e-3_lip3_4/cert_2.pt"
    controller_file = "/Users/javiergutierrez/Documents/Thesis/Thesis_Repo/InvertedPendulum_UIUC/controllers_epsl_5e-3_lip3_4/controller_2.pt"


    comb_file = "/Users/javiergutierrez/Documents/Thesis/Thesis_Repo/InvertedPendulum_UIUC/combined_epsl_5e-3_lip3_4/combined_2.onnx"

    combined_model(cert_file, controller_file, comb_file, "cpu")

    model_onnx_file = "/Users/javiergutierrez/Documents/Thesis/Thesis_Repo/InvertedPendulum_UIUC/models_epsl_5e-3_lip3_4/cert_2.onnx"
