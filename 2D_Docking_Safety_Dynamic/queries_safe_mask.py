...
class Queries:
    ...
    def encodeDifferences(self, network, inp, out):
        if len(inp) != len(out):
    ...
    def run_unroll(self, network):
        ...
        x_0, y_0, v_x_0, v_y_0, x_1, y_1, v_x_1, v_y_1 = first_state[0], first_state[1], first_state[2], first_state[3], \
                                                         ...
                                                         second_state[3]
        F_x, F_y, init_val, out_val, x_d_1, y_d_1, v_x_d_1, v_y_d_1 = first_output[0], first_output[1], second_output[0], third_output[0], dyn_output[0], dyn_output[1], dyn_output[2], dyn_output[3]
        ...
        d_x_1, d_y_1, d_v_x_1, d_v_y_1 = self.encodeDifferences(network, [x_1, y_1, v_x_1, v_y_1], [x_d_1, y_d_1, v_x_d_1, v_y_d_1])
...
import torch
from training_exp_safe_mask import TwoDimDocking
...
if __name__ == "__main__":
    ...
    vals, ranges, failed = safe_descent_cond_check("/Users/javiergutierrez/Documents/Thesis/Thesis_Repo/2D_Docking_Safety_Dynamic/combined/combined_5.onnx", "models/cert_5_veri.onnx", limit_pos = 2, safe_pos = 1, docking_pos = 0.35, vel_limit = vel_limit)
